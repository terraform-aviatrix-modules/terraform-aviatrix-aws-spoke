...
locals {
  ...
  subnet            = var.insane_mode ? cidrsubnets(aviatrix_vpc.default.cidr, 3)[length(cidrsubnets(aviatrix_vpc.default.cidr, 3)) - 2] : aviatrix_vpc.default.subnets[length(aviatrix_vpc.default.subnets) / 2].cidr
  ha_subnet         = var.insane_mode ? cidrsubnets(aviatrix_vpc.default.cidr, 3)[length(cidrsubnets(aviatrix_vpc.default.cidr, 3)) - 1] : aviatrix_vpc.default.subnets[length(aviatrix_vpc.default.subnets) / 2 + 1].cidr
